...
export class _Blank extends React.Component {
  ...
  state = {
    Datepicker_3: new Date("08/06/2020"),
    Input_4: "87887987987987",
    Input_5: "gvhfvhgvhgvhg",
    Toggle_7: true
  }
  ...
  render = () => (
    ...
    >
      ...
      <Image
        ...
        source={{
          uri:
            "https://d3nfddh2sbo9hk.cloudfront.net/media/project_component_resources/8_sFLb7Yz.jpg"
        }}
        style={{
          width: 100,
          height: 100,
